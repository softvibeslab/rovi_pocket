...
export const demoFlowSteps: DemoStep[] = [
  {
    id: "dashboard",
    label: "Paso 1",
    title: "Arranca en Modo Momentum",
    body: "La app te muestra el movimiento mas importante del dia, el lead critico y la accion exacta para ejecutarla.",
    tab: "home",
    cta: "Ejecutar movimiento principal",
  },
  {
    id: "leads",
    label: "Paso 2",
    title: "Explora el insight del lead",
    body: "Valida pain point, score, riesgo y guion sugerido desde el pipeline operativo.",
    tab: "leads",
